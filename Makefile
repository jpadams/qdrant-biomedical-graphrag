...
run-graph-analytics: ## Run GDS community detection, centrality, and link prediction
	@echo "Running graph analytics (requires GDS credentials in .env)..."
	uv run src/biomedical_graphrag/infrastructure/neo4j_db/gds_analytics.py
